...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    submitFiles: function submitFiles() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/select-files', formData, {
        headers: {
            ...
            [
              ...
              _vm._l(_vm.files, function (file, key) {
                return _c(
                  ...
                  {
                    staticClass:
                      "image__item col-span-2 grid grid-cols-2 rounded-lg border gap-3 border-slate-200 p-3",
                  },
                  [
                    _c("img", {
                      staticClass: "rounded-lg bg-slate-100",
                      attrs: { src: file.name, alt: "" },
                    }),
                    _vm._v(" "),
                    _c(
                      "div",
                      { staticClass: "image__data" },
                      [
