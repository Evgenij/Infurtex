<template>
    <div class="block-test flex flex-col rounded-lg bg-white py-4 px-5 space-y-3 transform hover:-translate-y-1">
        <main class="border-bottom-2 border-slate-100 flex justify-between">
            ...
            <div class="test-content flex items-center space-x-10">
                <div v-if="category !== 'finished'" class="test-content__data flex items-center space-x-4">
                ...
                <div v-if="category !== 'finished' && category !== 'new'" class="active-buttons flex items-center space-x-2">
                ...
                <div v-else-if="category === 'finished'" class="active-buttons flex items-center space-x-2">
        ...
        <footer class="flex items-center justify-between text-sm text-slate-500">
            <div class="owner flex items-center space-x-2">
                <div class="type-test text-sm flex items-center font-medium p-1 px-2 rounded bg-slate-100">
                    <i class="bx mr-1"
                        :class="{
                ...
                <div class="owner-test text-sm flex items-center font-medium p-1 px-2 rounded bg-slate-100">
                    <i class="bx mr-1"
                        :class="{
